...
# We now go back to the perceptron algorithm of chapter {ref}`perc-lab` to look in some more detail at its performance as a function of weights. Note that in our example with points on the plane the condition for the pink points is given by the inequality
# 
